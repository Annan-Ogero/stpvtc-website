...
/* ── Root-level nav: fix paths for index.html ── */
const NAV_HTML_ROOT = NAV_HTML
  .replace(/href="\.\.\/index\.html"/g, 'href="index.html"')
  .replace(/src="\.\.\/images\//g, 'src="images/')
  .replace(/href="(?!\.\.\/|http|#|mailto|tel)([^"]+\.html[^"]*)"/g, (m, path) => {
    if (path === 'index.html') return m;
    if (path.startsWith('pages/')) return m;
    return `href="pages/${path}"`;
  });
    ...
    <div class="footer__grid">
      <div class="footer__brand">
        ...
        <div class="footer__social" aria-label="Social media links">
          ...
          <a href="https://www.instagram.com/zygoatfans?igsh=d3U3ZDU4YzRhNmNx" aria-label="Instagram" target="_blank" rel="noopener">
          ...
          <a href="https://wa.me/message/4F25T6F3THPNM1" aria-label="WhatsApp" target="_blank" rel="noopener">
          ...
          <a href="https://youtube.com/@annanogero?si=IOK8FFGETl2X4Be1" aria-label="YouTube" target="_blank" rel="noopener">
...
function injectFooter() {
  ...
  if (isRoot()) {
    html = html
      .replace(/href="\.\.\/index\.html"/g, 'href="index.html"')
      .replace(/src="\.\.\/images\//g, 'src="images/')
      .replace(/href="(?!\.\.\/|http|#|mailto|tel|pages\/)([^"]+\.html[^"]*)"/g, (m, path) => {
        return `href="pages/${path}"`;
      });
  }
  placeholder.outerHTML = html;
